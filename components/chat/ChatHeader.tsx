  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2 min-w-0">
        ...
        {/* ── LEFT — Vault + document row (selector flexes; AES never overlaps) ── */}
        <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1 overflow-hidden mr-1">
          ...
          {/* Document name (shrinks) + AES (fixed) — explicit gap so labels never touch */}
          <div className="flex items-center gap-3 min-w-0 flex-1">
            <div ref={selectorRef} className="relative min-w-0 flex-1">
              <button
                ...
                className="flex w-full min-w-0 max-w-full overflow-hidden items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-1"
              >
                <FileText className="w-3.5 h-3.5 text-slate-500 dark:text-slate-400 shrink-0" aria-hidden="true" />
                <span className="text-xs font-semibold text-slate-700 dark:text-slate-300 truncate min-w-0 flex-1 text-left">
            ...
            {/* AES-256 security badge — shrink-0 keeps gap-3 honest on long filenames */}
            <div
              className="hidden md:flex shrink-0 items-center gap-1 px-2 py-1 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 rounded text-emerald-700 dark:text-emerald-400"
